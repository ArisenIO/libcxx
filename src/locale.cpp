...
extern "C" void arisen_assert(bool, const char*);
size_t strftime(char*, size_t, const char*, const struct tm*) { arisen_assert(false, "strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { arisen_assert(false, "strftime_l called"); }
